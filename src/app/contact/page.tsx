          ...
          <div className="space-y-6">
            <div className="p-8 bg-blue-50 rounded-[2rem] border border-blue-100 flex items-start space-x-6">
              ...
              <div>
                ...
                <p className="text-gray-600 font-medium">support@jerrytiktoktool.com</p>
            ...
            <div className="p-8 bg-green-50 rounded-[2rem] border border-green-100 flex items-start space-x-6">
              ...
              <div>
                ...
                <p className="text-gray-600 font-medium">Jerry TikTok Tool - Independent Assistant</p>
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" placeholder="Jerry Dev" className="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all" />
                </div>
                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-widest">Email Address</label>
                  <input type="email" placeholder="jerry@example.com" className="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all" />
                </div>
              </div>
